            ...
            <div className="navbar bg-gradient-to-b from-gray-800 to-gray-900 text-yellow-500 p-4 ">
                <div className="lg:navbar-start justify-between w-full">
                    <div className="dropdown">
                        <div tabIndex={0} role="button" className=" lg:hidden">
                            <RxActivityLog className="text-3xl hover:scale-75"></RxActivityLog  >
                        </div>
                        <ul
                            tabIndex={0}
                            ...
                            <div className="flex items-center bg-gray-700 rounded-lg p-2 mt-2">
                                ...
                                <div className="flex flex-col gap-2 lg:flex-row ">
                                    {
                                        user && user?.email ? <button onClick={logOut} className="btn btn-sm text-sm font-medium bg-gradient-to-b from-gray-600 to-gray-900 text-yellow-300 uppercase">Log Out</button> : <Link to="/login" className="btn btn-sm text-sm font-medium bg-gradient-to-b from-gray-600 to-gray-900 text-yellow-300 uppercase">Log In</Link>
                                    }
                                    <Link to="/register" className="btn btn-sm text-sm font-medium bg-gradient-to-b from-gray-600 to-gray-900 text-yellow-300 uppercase">Register</Link>
                                </div>
                            </div>
                        </ul>
                    </div>
                ...
                <div className="navbar-end hidden lg:flex">
                    ...
                    <div className="flex flex-col gap-2 lg:flex-row ">
                        ...
                        <Link to="/register" className=" btn btn-outline text-base rounded-br-2xl rounded-tl-3xl font-medium bg-gradient-to-b from-gray-600 to-gray-900 text-yellow-300 uppercase tracking-wide border-purple-500 shadow-md hover:shadow-white hover:scale-105 hover:text-white transition-transform ">Register</Link>
                    </div>
                </div>
            </div>
        </div>
