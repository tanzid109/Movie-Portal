        ...
        <div className="card bg-gray-800 shadow-lg text-white hover:scale-105 transition-transform duration-300 rounded-lg p-5">
            ...
            <div className="card-body justify-center items-center p-4">
                ...
                <div className="card-actions mt-4">
                    <Link to={`moviedetails/${_id}`} className="btn btn-outline text-base rounded-br-2xl rounded-tl-3xl font-medium bg-gradient-to-b from-gray-600 to-gray-900 text-yellow-300 uppercase tracking-wide border-purple-500 shadow-md hover:shadow-white hover:scale-105 hover:text-white transition-transform">See Details</Link>
                </div>
            </div>
        </div>
    );
